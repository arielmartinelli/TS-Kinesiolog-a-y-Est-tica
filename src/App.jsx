      ...
      <main className="flex-grow flex flex-col pt-16 md:pt-24">
        ...
        <section id="servicios" className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Card 1: Kinesiología */}
            <div id="kinesio" className="scroll-mt-24 bg-white rounded-2xl border border-[#e5e2dd] overflow-hidden shadow-[0_4px_20px_rgba(111,88,60,0.06)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
              <div>
            ...
            {/* Card 2: Estética */}
            <div id="estetica" className="scroll-mt-24 bg-white rounded-2xl border border-[#e5e2dd] overflow-hidden shadow-[0_4px_20px_rgba(111,88,60,0.06)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
              <div>
                <div className="relative h-56 w-full overflow-hidden bg-[#e5e2dd]">
                  <img
            ...
            <div id="masajes" className="scroll-mt-24 bg-white rounded-2xl border border-[#e5e2dd] overflow-hidden shadow-[0_4px_20px_rgba(111,88,60,0.06)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between md:col-span-2 lg:col-span-1">
              <div>
                <div className="relative h-56 w-full overflow-hidden bg-[#e5e2dd]">
                  <img
        ...
        <section id="testimonios" className="scroll-mt-24 bg-[#f6f3ee] py-16 md:py-24 border-y border-[#e5e2dd]">
        ...
        <section id="contacto" className="scroll-mt-24 py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 h-80 sm:h-[420px] bg-[#e5e2dd] rounded-3xl overflow-hidden border border-[#e5e2dd] shadow-sm relative">
              <iframe
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-3xl border border-[#e5e2dd] shadow-sm flex flex-col gap-5">
